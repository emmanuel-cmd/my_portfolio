print("This program determines students performance based on entered records")
data_valid = False
...
while data_valid == False:
    ...
    if absences < 0 or absences > total_classes: 
        print("The number of absences can't be less than zero or greater than number of total classes")
        continue
    else:
        data_valid = True
